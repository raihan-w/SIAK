...
<body>
    <div class="pappersize">
        ...
        <p class="kd-srt">nomor kode desa : <?= $desa['kode_desa']; ?></p>
        ...
        <p>Sepanjang pengetahuan kami dan berdasarkan pengakuan warga tersebut, bahwa ; <?= $data['keterangan']; ?></p>
