        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="progressbar">
                    ...
                    <div class="progress-step" data-title="Isi Surat"><i class="fas fa-keyboard"></i></div>
                ...
                <form class="user" id="blangko">
                    ...
                    <div class="form-step">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <textarea name="keterangan" id="keterangan" cols="3" rows="3" class="summernote-simple"></textarea>
                            </div>
                        </div>
                        <br>
                        <div class="text-right">
                    ...
                    <div class="form-step">
                        <div class="form-group m-2 row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="perihal" id="perihal" value="Beda Nama" readonly>
                            </div>
                        </div>
                        <div class="form-group m-2 row">
                ...
                <form action="<?= base_url('persuratan/print_bedanama'); ?>" method="POST" target="_blank">
                    <?= csrf_field(); ?>
...
<script>
    $(document).ready(function() {
        ...
        $('#blangko').submit(function(e) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo base_url('persuratan/generate_bedanama') ?>",
