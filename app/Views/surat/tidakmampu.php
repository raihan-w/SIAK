        ...
        <table class="surat">
            <tr>
                <td>
                    ...
                    tanggal <?= date('d F Y', strtotime($data['tgl_pengantar'])); ?>, bahwa yang bersangkutan betul warga domisili di Desa Geneng 
                    dan menurut pengakuan yang bersangkutan keadaan ekonominya TIDAK MAMPU
                </td>
            </tr>
            <tr>
                <td>
                    Surat ini diperlukan untuk <?= $data['keterangan']; ?>
                </td>
            </tr>
            <tr>
                <td>
