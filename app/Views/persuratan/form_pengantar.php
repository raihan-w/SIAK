    ...
    <div class="section-body">
        <div class="card">
            <div class="card-body">
                ...
                <form class="user" id="blangko">
                    ...
                    <div class="form-step">
                        <div class="form-group m-2 row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="perihal" id="perihal" value="Pengantar" readonly>
                            </div>
                        </div>
                        <div class="form-group m-2 row">
                ...
                <form action="<?= base_url('persuratan/print_pengantar'); ?>" method="POST" target="_blank">
                    <?= csrf_field(); ?>
                    <div class="form-group">
...
<script>
    $(document).ready(function() {
        ...
        $('#blangko').submit(function(e) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo base_url('persuratan/generate_pengantar') ?>",
