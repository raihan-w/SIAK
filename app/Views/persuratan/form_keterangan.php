    ...
    <div class="section-body">
        <div class="card">
            <div class="card-body">
                ...
                <form class="user" id="blangko">
                    ...
                    <div class="form-step">
                        <div class="form-group">
                            ...
                            <textarea class="form-control summernote-simple" name="keperluan" id="keperluan" cols="3" rows="5"></textarea>
                        </div>
                        <div class="form-group">
                            <label class="form-label text-md-right">Keterangan Lain</label>
                            <textarea class="form-control summernote-simple" name="keterangan" id="keterangan" cols="3" rows="5"></textarea>
                        </div>
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label class="form-label text-md-right" for="">Berlaku</label>
                                <input type="date" class="form-control" name="dateNow" id="dateNow">
                            </div>
                            <div class="col-md-6 form-group">
                                <label class="form-label text-md-right" for="">Sampai Dengan</label>
                    ...
                    <div class="form-step">
                        <div class="form-group m-2 row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="perihal" id="perihal" value="Keterangan" readonly>
                            </div>
                        </div>
                        <div class="form-group m-2 row">
                ...
                <form action="<?= base_url('persuratan/print_keterangan'); ?>" method="POST" target="_blank">
                    <?= csrf_field(); ?>
                    <div class="form-group">
...
<script>
    $(document).ready(function() {
        ...
        $('#blangko').submit(function (e) { 
            ...
            $.ajax({
                type: "post",
                url: "<?php echo base_url('persuratan/generate_keterangan') ?>",
